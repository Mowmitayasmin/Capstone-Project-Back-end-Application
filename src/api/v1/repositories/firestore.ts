...
export const runTransaction = async <T>(
  ...
  try {
    ...
    throw new RepositoryError(`Transaction failed`, "TRANSACTION_FAILED");
  }
};
...
export const createItems = async <T>(
  ...
  try {
    ...
    throw new RepositoryError("Failed to create", "FAILED_CREATE");
  }
};
...
export const getItems = async (
  ...
  try {
    ...
    throw new RepositoryError("Retrive issue", "RETRIVE_ISSUE");
  }
};
...
export const updateItems = async <T>(
  ...
  try {
    ...
    throw new RepositoryError("Item can not update", "NOT_FOUND", 422);
  }
};
